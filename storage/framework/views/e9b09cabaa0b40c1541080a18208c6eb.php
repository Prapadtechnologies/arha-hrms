...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
        <ul class="dash-navbar">
                ...
                <?php else: ?>
                    <li class="dash-item <?php echo e(Request::segment(1) == 'employee' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('employee.index')); ?>" class="dash-link"><span class="dash-micon"><i
                                ...
                                class="dash-mtext"><?php echo e(__('Manage Employees')); ?></span></a>
                    </li>
                <?php endif; ?>
            <?php endif; ?>
            <!-- employee-->
            ...
            <?php if(Gate::check('Manage Attendance') || Gate::check('Manage Leave') || Gate::check('Manage TimeSheet')): ?>
                <li
                    ...
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                            ...
                            class="dash-mtext"><?php echo e(__('Manage Attendance')); ?></span><span class="dash-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="dash-submenu">
            ...
            <?php if(Gate::check('Manage Employee')): ?>
                <?php if(\Auth::user()->type == 'hr'): ?>
                    <li class="dash-item <?php echo e(Request::segment(1) == 'employee' ? 'active' : ''); ?>">
                        <a href="<?php echo e(route('employee.index')); ?>" class="dash-link"><span class="dash-micon"><i
                                        class="ti ti-user"></i></span><span
                                    class="dash-mtext"><?php echo e(__('HR Letter')); ?></span></a>
                    </li>
                <?php endif; ?>
            <?php endif; ?>
            <!-- employee-->
            ...
            <?php if(Gate::check('Manage Assets')): ?>
                <li class="dash-item">
                    <a href="<?php echo e(route('account-assets.index')); ?>" class="dash-link"><span class="dash-micon"><i
                            ...
                            class="dash-mtext"><?php echo e(__('Company Assets')); ?></span></a>
                </li>
            <?php endif; ?>
            ...
            <?php endif; ?>
            <!--chats-->
            <?php if(\Auth::user()->type == 'admin' || \Auth::user()->type == 'hr'): ?>
...
<?php /**PATH E:\xampp\htdocs\arha-hrms\resources\views/partial/Admin/menu.blade.php ENDPATH**/ ?>