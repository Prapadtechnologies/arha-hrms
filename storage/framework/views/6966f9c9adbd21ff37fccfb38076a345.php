    ...
    <div class="row">
        <div class="">
            <div class="">
                ...
                <?php if(\Auth::user()->type == 'employee' || \Auth::user()->type == 'hr' || \Auth::user()->type == 'admin'): ?>
                    <div class="row">
                        <div class="col-md-6 ">
                            <div class="card em-card">
                                <div class="card-header">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\arha-hrms\resources\views/employee/edit.blade.php ENDPATH**/ ?>